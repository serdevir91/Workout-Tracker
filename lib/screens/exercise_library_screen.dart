...
class _ExerciseLibraryScreenState extends State<ExerciseLibraryScreen> {
  ...
  static const List<_CategoryMeta> _categoryDefs = [
    ...
    _CategoryMeta('Lower Back', Icons.airline_seat_recline_normal_rounded, Color(0xFF26A69A)),
    _CategoryMeta('Shoulders', Icons.accessibility_new_rounded, Color(0xFFFFBE0B)),
    _CategoryMeta('Biceps', Icons.sports_martial_arts_rounded, Color(0xFFFF006E)),
    _CategoryMeta('Triceps', Icons.sports_gymnastics_rounded, Color(0xFFD63384)),
    ...
    _CategoryMeta('Quadriceps', Icons.directions_walk_rounded, Color(0xFF00D4AA)),
    _CategoryMeta('Hamstrings', Icons.airline_seat_legroom_reduced_rounded, Color(0xFF0EA5E9)),
    _CategoryMeta('Glutes', Icons.airline_seat_legroom_extra_rounded, Color(0xFFFB5607)),
